...
# Simple Vast.AI terminal script: EfficientNetV2S Round1 on GPU X.
...
CUDA_VISIBLE_DEVICES=X python Train_VastAI_HF_Zip_DDP.py \
  ...
  --hf_results_path_in_repo "EfficientNetV2S/Round1" \
  --round_name "PBC_MULTICLASS_EfficientNetV2S_Round1" \
